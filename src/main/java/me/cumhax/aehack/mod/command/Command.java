package me.cumhax.aehack.mod.command;
...
public abstract class Command extends Feature {
    ...
    public static void sendMessage(String message) {
        Command.sendSilentMessage(ae.commandManager.getClientMessage() + " " + ChatFormatting.GRAY + message);
    }
    ...
    public static String getCommandPrefix(String s) {
        return ae.commandManager.getPrefix();
    }
