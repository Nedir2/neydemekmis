package me.cumhax.aehack.mod.gui;
...
import me.cumhax.aehack.mod.gui.components.items.buttons.ModuleButton;
...
public class ClickGui extends GuiScreen {
    ...
    private void load() {
        int x = -84;
        for (final Module.Category category : ae.moduleManager.getCategories()) this.components.add(new Component(category.getName(), x += 85, 13, true) {
            @Override
            public void setupItems() {
                ae.moduleManager.getModulesByCategory(category).forEach(module -> {
