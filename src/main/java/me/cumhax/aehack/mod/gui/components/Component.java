package me.cumhax.aehack.mod.gui.components;
...
import me.cumhax.aehack.mod.gui.components.items.buttons.Button;
...
//        RenderMethods.drawGradientRect(this.x, (float)this.y - 1.5f, this.x + this.width, this.y + this.height - 6, -7829368, -6710887);
        ...
        ae.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) ClickGui.getClickGui().getTextOffset(), -1);
