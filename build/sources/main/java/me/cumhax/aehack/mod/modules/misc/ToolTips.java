...
public class ToolTips extends Module {
    ...
    private static final ResourceLocation BOOK_GUI_TEXTURE = new ResourceLocation("textures/gui/booky.png");
    ...
    public void renderShulkerToolTip(ItemStack stack, int x, int y, String name) {
        ...
        if (tagCompound != null && tagCompound.hasKey("BlockEntityTag", 10) && (blockEntityTag = tagCompound.getCompoundTag("BlockEntityTag")).hasKey("Items", 9)) {
            ...
            Color color = new Color(ClickGuiModule.INSTANCE.red.getValue(), ClickGuiModule.INSTANCE.green.getValue(), ClickGuiModule.INSTANCE.blue.getValue(), 200);
