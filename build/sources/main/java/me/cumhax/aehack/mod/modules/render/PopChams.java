...
import me.cumhax.aehack.event.events.PacketEvent;
import me.cumhax.aehack.mod.modules.Module;
import me.cumhax.aehack.mod.setting.Setting;
import me.cumhax.aehack.util.NordTessellator;
import me.cumhax.aehack.util.TotemPopCham;
...
public class PopChams extends Module {
    ...
    public static final Setting<Integer> rL = new Setting<Integer>("RedLine", 0, 0, 255);
    public static final Setting<Integer> gL = new Setting<Integer>("GreenLine", 255, 0, 255);
    public static final Setting<Integer> bL = new Setting<Integer>("BlueLine", 255, 0, 255);
    public static final Setting<Integer> aL = new Setting<Integer>("AlphaLine", 0, 0, 255);

    public static final Setting<Integer> rF = new Setting<Integer>("RedFill", 0, 0, 255);
    public static final Setting<Integer> gF = new Setting<Integer>("GreenFill", 255, 0, 255);
    public static final Setting<Integer> bF = new Setting<Integer>("BlueFill", 255, 0, 255);
    public static final Setting<Integer> aF = new Setting<Integer>("AlphaFill", 50, 0, 255);
