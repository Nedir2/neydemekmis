...
import me.cumhax.aehack.utils.EntityUtil;
...
public class Surround
    ...
    private final me.cumhax.aehack.utils.Timer timer = new me.cumhax.aehack.utils.Timer();
    private final me.cumhax.aehack.utils.Timer retryTimer = new Timer();
    ...
    public Surround() {
        super("Surrond", "Surrounds you with Obsidian", Module.Category.COMBAT, true, false, false);
    }
    ...
    public void onEnable() {
        ...
        if (this.center.getValue().booleanValue()) {
            ae.positionManager.setPositionPacket((double) this.startPos.getX() + 0.5, this.startPos.getY(), (double) this.startPos.getZ() + 0.5, true, true, true);
        }
        this.retries.clear();
        ...
        for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1: {
                    ...
                    if (ae.speedManager.getSpeedKpH() != 0.0 || isExtending || this.extenders >= 1) continue block5;
